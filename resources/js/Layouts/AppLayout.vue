<template>
    <div class="h-screen">
        <nav aria-label="navbar" class="fixed bg-white border-b border-gray-200 w-full">
            <!-- Primary Navigation Menu -->
            <div class="max-w-full px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <!-- Logo -->
                        <div class="flex-shrink-0 flex items-center sm:ml-16">
                            <inertia-link :href="route('dashboard')">
                                <a class="navbar text-blue-600 text-xl sm:text-3xl" href="/">Semba.co</a>
                            </inertia-link>
                        </div>
                    ...
                    <!-- Settings Dropdown -->
                    <div class="hidden sm:flex sm:items-center sm:mr-16">
        ...
        <!-- Page Content -->
        <main class="flex bg-gray-100 pt-16 min-h-full h-auto">
            <!-- Sidebar -->
            <nav aria-label="sidebar" class="navbar flex flex-col hidden sm:block bg-blue-600 w-auto text-center p-4">
                <div class="flex sticky top-20 items-center md:mx-4 lg:mx-8 xl:mx-14 2xl:mx-10 w-full">
                    <svg class="h-8 mr-1" fill="white" viewBox="0 0 20 20">
                ...
                <div class="flex sticky top-32 items-center md:mx-4 lg:mx-8 xl:mx-14 2xl:mx-10 w-full">
                    <svg class="h-8 mr-1" fill="white" viewBox="0 0 20 20">
                    ...
                    <jet-nav-link :href="route('permintaan')" :active="route().current('permintaan')">
                        Permintaan
                    </jet-nav-link>
                </div>
                <div class="flex sticky top-44 items-center md:mx-4 lg:mx-8 xl:mx-14 2xl:mx-10 w-full">
                    <svg class="h-8 mr-1" fill="white" viewBox="0 0 20 20">
                    ...
                    <jet-nav-link :href="route('bantuan')" :active="route().current('bantuan')">
                        Bantuan
                    </jet-nav-link>
                </div>
                <div class="flex sticky top-56 items-center md:mx-4 lg:mx-8 xl:mx-14 2xl:mx-10 w-full">
                    <svg class="h-8 mr-1" fill="white" viewBox="0 0 20 20">
                    ...
                    <jet-nav-link :href="route('berita')" :active="route().current('berita')">
                        Berita
                    </jet-nav-link>
                </div>
                <div class="flex sticky items-center md:mx-4 lg:mx-8 xl:mx-14 2xl:mx-10 w-full" style="top: 17rem;">
                    <svg class="h-8 mr-1" fill="white" viewBox="0 0 20 20">
                ...
                <div class="flex sticky top-80 items-center md:mx-4 lg:mx-8 xl:mx-14 2xl:mx-10 w-full">
                    <svg class="h-8 mr-1" fill="white" viewBox="0 0 20 20">
